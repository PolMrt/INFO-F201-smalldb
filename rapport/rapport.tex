...
Dans un premier temps, nous avons testé sur un partage de connexion fait via un iPhone mais tous les résultats retournés par le serveur étaient étranges.
